...
class SoldierTest {
   ...
   @Test
   public void soldier_test_receive_2_arguments() {
 Soldier soldier = new Soldier(health, strength);
   ...
   @Test    public void should_receive_the_health_property_as_its_2st_argument() {
        Soldier soldier = new Soldier(health, strength);
...
Soldier soldier = new Soldier(health, strength);
   ...
   int resultAttack = soldier.attack();
    ...
    @Test public void attack_should_return_a_integer() {
        Soldier soldier = new Soldier(health, strength);int resultAttack = soldier.attack();
   ...
   public void attack_should_return_the_strength_property_of_the_Soldier() {
      Soldier soldier = new Soldier(health, strength); var resultAttack = soldier.attack();
