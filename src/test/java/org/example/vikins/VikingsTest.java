...
class VikingTest {
    ...
    @Test public void should_inherit_from_Soldier() {
   ...
   public void should_receive_the_strength_property_as_its_3st_argument() {
    ...
    @Test public void attack_should_return_strength_property_of_the_Saxon() {
   ...
   @Test public void should_remove_the_received_damage_from_the_health_property() {
        viking.receiveDamage(50);
        assertEquals(250, viking.getHealth());
   }
